...
Puppet::Functions.create_function(:edit_account) do
  ...
  def execute(server_url, authtoken, org, certificate, account_id, account_title, account_name, account_type,
              personal_account, ipaddress, notes, tags, folder_id, account_expiration_date, distinguished_name, account_alias, domain_name)
